        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Patient_ApplicationUserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_AspNetUsers_Patient_ApplicationUserId",
                        column: x => x.Patient_ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Appointments", x => new { x.DoctorId, x.Day });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoctorId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Day = table.Column<int>(type: "int", nullable: false),
                    TimeInHours = table.Column<TimeOnly>(type: "time", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Times_Appointments_AppointmentDoctorId_AppointmentDay",
                        columns: x => new { x.AppointmentDoctorId, x.AppointmentDay },
                        principalTable: "Appointments",
                        principalColumns: new[] { "DoctorId", "Day" },
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_Patient_ApplicationUserId",
                table: "AspNetUsers",
                column: "Patient_ApplicationUserId",
                unique: true,
                filter: "[ApplicationUserId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Times_AppointmentDoctorId_AppointmentDay",
                table: "Times",
                columns: new[] { "AppointmentDoctorId", "AppointmentDay" });
        }
