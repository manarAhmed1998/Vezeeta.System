...
namespace Vezeeta.System.DAL.Migrations
{
    ...
    [Migration("20231206072816_dbTrial")]
    partial class dbTrial
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Vezeeta.System.DAL.Specialization", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ed1eed6a-7707-472d-9289-c1ca9244f7d8"),
                            NameAr = "طب الباطنة",
                            NameEn = "Internal Medicine"
                        },
                        new
                        {
                            Id = new Guid("b31505d5-33a5-4dbf-b505-18bd422def19"),
                            NameAr = "القلب والاوعية الدموية",
                            NameEn = "Cardiology"
                        },
                        new
                        {
                            Id = new Guid("060e23eb-6a81-4dbf-a8e3-0902c0f4b500"),
                            NameAr = "نساء وتوليد",
                            NameEn = "Obstetrics and Gynecology"
                        },
                        new
                        {
                            Id = new Guid("5794fa5b-d4ec-4a1d-9a49-2610a0a8bdd3"),
                            NameAr = "طب العيون",
                            NameEn = "Ophthalmology"
                        },
                        new
                        {
                            Id = new Guid("092bff87-fcd2-4680-9df4-b183842da4d9"),
                            NameAr = "طب اطفال",
                            NameEn = "Pediatrics"
                        },
                        new
                        {
                            Id = new Guid("974554ad-07bc-4ba8-b955-89b0b905cd2b"),
                            NameAr = "طب الاعصاب",
                            NameEn = "Neurology"
                        },
                        new
                        {
                            Id = new Guid("110dc8e8-ae9b-40eb-ac57-2445abe20c79"),
                            NameAr = "طب الاورام",
                            NameEn = "Oncology"
                        },
                        new
                        {
                            Id = new Guid("534cb8fe-b185-4692-b0a8-94eee8f307f0"),
                            NameAr = "المسالك البولية",
                            NameEn = "Urology"
                        },
                        new
                        {
                            Id = new Guid("6b5eb3a4-7d02-4872-a8d7-97bfe6a7a33e"),
                            NameAr = "جلدية",
                            NameEn = "Dermatology"
                        });
                });
